pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~test_locomotion_interlock.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~test_locomotion_interlock.adb");
...
package body ada_main is
   ...
   E137 : Short_Integer; pragma Import (Ada, E137, "ada__assertions_E");
   ...
   E133 : Short_Integer; pragma Import (Ada, E133, "locomotion_interlock_E");
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_test_locomotion_interlock");
...
--  BEGIN Object file/option list
   --   /workspace/rivr-ada/Ada-Locomotion-Mode-Interlock/obj/locomotion_interlock.o
   --   /workspace/rivr-ada/Ada-Locomotion-Mode-Interlock/obj/test_locomotion_interlock.o
   --   -L/workspace/rivr-ada/Ada-Locomotion-Mode-Interlock/obj/
   --   -L/workspace/rivr-ada/Ada-Locomotion-Mode-Interlock/obj/
   --   -Lsrc/
